# Lecture 01 - MLIR and AI/NPU Compiler Big Picture

이 파일은 원본 자료를 강의자가 바로 진행할 수 있도록 재구성한 진행안입니다. 원본 PDF/PPTX/DOCX는 보존되어 있고, 실습은 `examples/`와 `Worksheet`를 기준으로 진행합니다.

## 1. 학습 목표

- 이번 장의 핵심 주제인 `MLIR and AI/NPU Compiler Big Picture`를 MLIR/NPU compiler pipeline 안에서 설명할 수 있습니다.
...
- 슬라이드: `MLIR_NPU_Lecture_01_Slides.pdf`
- 강의 노트: `MLIR_NPU_Lecture_01_Notes.pdf`
- 핸드아웃: `MLIR_NPU_Lecture_01_Handout.md`
- 워크시트: `MLIR_NPU_Lecture_01_Worksheet.pdf`
...
- `examples/lecture01_matmul_pipeline_notes.md` - 체크리스트/설명 문서
- `examples/lecture01_pipeline_skeleton.mlir` - MLIR IR 예제
